      ...
      <div className="flex flex-col p-10">
        ...
        <div>
          <div className="flex justify-center">
            <input
              type="text"
              className="w-[70px] h-[60px] rounded-[16px]  text-center placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 mx-2"
              placeholder="14:45"
            ></input>

            <input
              type="text"
              className="w-[550px] h-[60px] rounded-[16px]  text-center placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 mx-2"
              placeholder="Invoice Name / Number"
            ></input>
            ...
            <button className="w-[59px] h-[59px] bg-[rgba(66,105,225,1)] text-white rounded-[8px] h-16 text-align-center mb-8 flex justify-center items-center mx-2">
              <img src="../../../Download.svg" alt="An SVG of an eye" />
            </button>
          </div>
        </div>
