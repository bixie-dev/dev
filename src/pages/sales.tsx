  ...
  return (
    <div className="p-4 mx-8">
      ...
      <div className="px-24 mb-12 flex grid-cols-12 gap-16 justify-center">
        ...
        <SalesChoose children={{ sale_name: "Mitarbeiterkosten", price: 50000 }} />
      ...
      <div className="text-[14px] px-16">
        <table className="w-full text-[20px] text-left">
          ...
          <SalesTb tb={{construction:{street:"Bruchhausenerstraße", city:"ddd", country:"sdd"}, revenue:50000, m_costs:1000, e_costs:5000, profit:46400}}/>
        </table>
      </div>
    </div>
  );
