      ...
      <div className="flex flex-col p-10">
        ...
        <div>
          <div className="grid grid-cols-2 gap-6 p-5">
            <div>
              <div className="text-[24px] font-bold mb-8">Settings</div>
              <div className="bg-white rounded-[8px] h-16 text-align-center mb-8 flex justify-between items-center px-3">
                <div className="font-medium">Edit profile</div>
                <img src="../../../Vector.svg" alt="An SVG of an eye" />
              </div>
              <div className="bg-white rounded-[8px] h-16 text-align-center mb-8 flex justify-between items-center px-3">
                <div className="font-medium">Change Phonenumber</div>
                <img src="../../../Vector.svg" alt="An SVG of an eye" />
              </div>
              <div className="bg-white rounded-[8px] h-16 text-align-center mb-8 flex justify-between items-center px-3">
            ...
            <div>
              <div className="text-[24px] font-bold mb-8">Legal</div>
              <div className="bg-white rounded-[8px] h-16 text-align-center mb-8 flex justify-between items-center px-3">
