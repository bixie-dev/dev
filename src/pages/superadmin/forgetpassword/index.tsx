      ...
      <div className="flex flex-col items-center max-w-500 login-inner-box">
        ...
        <div>
          <div className="pb-12">
            <input
              type="text"
              className="w-[500px] h-[60px] rounded-[16px] text-[16px] pl-3 placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1"
