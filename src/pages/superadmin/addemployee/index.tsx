...
const AddEmployee = () => {
  return (
    <div className="bg-[#F2F5FA] h-full">
      <div className="flex flex-col p-10">
        ...
        <div>
          ...
          <div className="flex justify-center">
            <input
              type="text"
              className="w-[500px] h-[60px] rounded-[16px]  text-center placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 mx-2"
              ...
              <span>
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M24.576 13.924L29.5463 8.95361C30.8797 7.62028 31.5463 6.95361 32.3748 6.95361C33.2032 6.95361 33.8699 7.62028 35.2032 8.95361L37.0463 10.7968L37.0464 10.7968C38.3797 12.1301 39.0463 12.7968 39.0463 13.6252C39.0463 14.4536 38.3797 15.1203 37.0464 16.4536L37.0463 16.4536L32.1166 21.3834C29.0056 19.5675 26.4142 16.9954 24.576 13.924ZM23.1217 15.3782L8.85615 29.6438C8.43109 30.0689 8.21856 30.2814 8.07883 30.5425C7.93909 30.8036 7.88015 31.0983 7.76226 31.6878L6.27186 39.1398C6.20534 39.4724 6.17208 39.6387 6.26668 39.7333C6.36129 39.8279 6.52757 39.7946 6.86013 39.7281L6.86017 39.7281L6.86021 39.7281L14.3122 38.2377C14.9016 38.1198 15.1964 38.0609 15.4575 37.9211C15.7186 37.7814 15.9311 37.5689 16.3562 37.1438L30.6586 22.8414C27.5984 20.9614 25.0213 18.4024 23.1217 15.3782Z"
                    fill="white"
                  />
                </svg>
              </span>
