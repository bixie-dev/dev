        ...
        <div className="w-[70px] rounded-[6px] text-right text-[12px] py-1 px-3 bg-[#7D7AFF] text-white flex items-center justify-between">
          <div>
            <svg width="10" height="10" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="9.5013" cy="9.50008" r="7.33333" stroke="white" stroke-width="2" />
              <path d="M13.0625 9.50008H9.75C9.61193 9.50008 9.5 9.38815 9.5 9.25008V6.72925" stroke="white" stroke-width="2" stroke-linecap="round" />
            </svg>
          </div>
          <div>
            {children.count}
