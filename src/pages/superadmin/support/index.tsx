/* eslint-disable */
import ToggleTab from "../../../toggle/index2";

const Support = () => {
  return (
    <div className="bg-[#F2F5FA] h-fit">
      <div className="flex flex-col py-5 px-32">
        ...
        <div>
          ...
          <div className="flex justify-end">
            <button className="w-[59px] h-[59px] bg-[#F2F5FA] text-white rounded-[8px] h-16 text-align-center mb-8 flex justify-center items-center mx-2">
              <span>
                <svg
                  width="59"
                  height="59"
                ...
                >
                  ...
                  />
                  <path
                    d="M39.542 14.3032C25.6568 14.3032 14.3877 25.5724 14.3877 39.4576C14.3877 53.3428 25.6568 64.6119 39.542 64.6119C53.4272 64.6119 64.6964 53.3428 64.6964 39.4576C64.6964 25.5724 53.4272 14.3032 39.542 14.3032ZM39.542 59.581C28.449 59.581 19.4186 50.5506 19.4186 39.4576C19.4186 28.3645 28.449 19.3341 39.542 19.3341C50.6351 19.3341 59.6655 28.3645 59.6655 39.4576C59.6655 50.5506 50.6351 59.581 39.542 59.581ZM51.0879 28.3393L34.5112 44.9161L27.9962 38.4262L24.4494 41.973L34.5112 52.0347L54.6346 31.9113L51.0879 28.3393Z"
                    fill="#52C41A"
                  />
                  <rect
                    x="2.84747"
          ...
          {/* first */}
          <div className="my-5">
            <div className="w-full rounded-[16px] p-5 placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1">
              {/* Check Button */}
              <div className="flex justify-end">
                <button className="w-[59px] h-[59px] bg-[#F2F5FA] text-white rounded-[8px] h-16 text-align-center mb-5 flex justify-center items-center mx-2">
                  <span>
                    <svg
                      width="59"
                      height="59"
              ...
              <div className="text-xl max-w-5xl">
                Take as many pixel-perfect UI elements as you want and style
                them the way you need in a fraction of the time. Take as many
                pixel-perfect UI elements as you want and style them the way you
                ...
                <button className="w-[59px] h-[59px] bg-[#F2F5FA] text-white rounded-[8px] h-16 text-align-center mb-5 flex justify-center items-center mx-2">
                  <span>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M25.6973 25.3103L55.7273 55.3403"
                        stroke="#F5222D"
                        strokeWidth="5.005"
                        strokeLinecap="round"
                      />
                      <path
                        d="M55.7273 25.3103L25.6973 55.3403"
                        stroke="#F5222D"
                        strokeWidth="5.005"
                        strokeLinecap="round"
                      />
          ...
          <div className="my-5">
            <div className="w-full rounded-[16px] p-5 placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1">
                ...
                <button className="w-[59px] h-[59px] bg-[#F2F5FA] text-white rounded-[8px] h-16 text-align-center mb-5 flex justify-center items-center mx-2">
                  <span>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M39.5399 14.9524C26.0607 14.9524 15.0322 25.9809 15.0322 39.4601C15.0322 52.9393 26.0607 63.9678 39.5399 63.9678C53.0192 63.9678 64.0476 52.9393 64.0476 39.4601C64.0476 25.9809 53.0192 14.9524 39.5399 14.9524ZM39.5399 59.0663C28.732 59.0663 19.9338 50.268 19.9338 39.4601C19.9338 28.6522 28.732 19.8539 39.5399 19.8539C50.3478 19.8539 59.1461 28.6522 59.1461 39.4601C59.1461 50.268 50.3478 59.0663 39.5399 59.0663ZM40.7653 27.2062H37.0892V41.9109L49.8332 49.7533L51.7938 46.5673L40.7653 39.9502V27.2062Z"
                        fill="#0E0F11"
                      />
                      <rect
                        x="2.77889"
              ...
              <div className="text-xl max-w-5xl">
                ...
                them the way you need in a fraction of the time. Take as many
                pixel-perfect UI elements as you want and style them the way you
                need in a fraction of the time support.
              </div>
              <div className="flex justify-end">
                <div className="w-60 bg-[#E6E5FF] py-2 my-2 pl-2 rounded-[8px] flex items-center  text-black">
                  <span>
