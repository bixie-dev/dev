  ...
  return (
    <div className="">
      <div className="flex flex-col items-center mt-12">
        ...
        <div className="text-[36px] font-bold mt-2 pb-2">
          A last step to login
        </div>
        ...
        <div>
          <div className="pb-12 flex">
            <input
              type="text"
              className="w-[60px] h-[60px] rounded-[16px] text-[32px] text-center placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 mx-2"
              placeholder=""
            ></input>
            <input
              type="text"
        ...
        <div className="pb-4">
          <button className="bg-[#4269E1] w-[500px] h-[60px] text-[#FFFFFF] rounded-[12px] text-[16px] font-[500]">
            Login
          </button>
        </div>
      </div>
